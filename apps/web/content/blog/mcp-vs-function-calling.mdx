...
faqItems:
  ...
  - question: "Does MCP work with models other than Claude?"
    answer: "Yes. MCP is a open protocol not tied to Anthropic. OpenAI, Google DeepMind, and several open-source model providers have implemented MCP clients. If you build an MCP server, it works with any client that supports the protocol, which is the main architectural advantage over function calling."
...
Yes. MCP is a open protocol not tied to Anthropic. OpenAI, Google DeepMind, and several open-source model providers have implemented MCP clients. If you build an MCP server, it works with any client that supports the protocol, which is the main architectural advantage over function calling.
